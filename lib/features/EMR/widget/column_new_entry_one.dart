...
class ColumnNewEntryOne extends StatefulWidget {
  @override
  _ColumnNewEntryState createState() => _ColumnNewEntryState();
}

class _ColumnNewEntryState extends State<ColumnNewEntryOne> {
    ...
    return Column(
      children: [
        ...
        ContainerNewEntry(
          ...
          imagePath: 'images/thermometers.svg',textDef: ' URL Document ',
          textOne: '˚C',
